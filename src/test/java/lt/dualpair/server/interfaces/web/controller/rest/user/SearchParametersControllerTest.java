...
public class SearchParametersControllerTest {
    ...
    public void testSetSearchParameters_exception() throws Exception {
        ...
        try {
            searchParametersController.setSearchParameters(1L, searchParametersResource, new UserDetailsImpl(1L));
            fail();
        } catch (Exception re) {
    ...
    public void testSetSearchParamters_invalidUser() throws Exception {
        ResponseEntity responseEntity = searchParametersController.setSearchParameters(2L, null, new UserDetailsImpl(1L));
