...
public class MatchController {
    ...
    public ResponseEntity next(@RequestParam(name = "exclopp[]", required = false) List<Long> excludeOpponents, @ActiveUser User principal) throws MatchRequestException {
        Match match;
        match = matchService.nextFor(principal.getId(), excludeOpponents);
        if (match == null) {
