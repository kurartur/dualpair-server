...
public class MatchController {
    ...
    public ResponseEntity response(@PathVariable Long matchId, @RequestBody String response) throws URISyntaxException {
        matchService.responseByUser(matchId, Response.valueOf(response), getUserPrincipal().getId());
    ...
    public ResponseEntity<List<MatchResource>> matches() {
        Set<Match> matches = matchService.getUserMutualMatches(getUserPrincipal().getId()); // TODO change this return all matches
