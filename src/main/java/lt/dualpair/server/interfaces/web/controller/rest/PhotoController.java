...
public class PhotoController {
    ...
    public ResponseEntity photo(@PathVariable Long photoId) throws PhotoServiceException, URISyntaxException {
        Photo photo = photoService.getUserPhoto(getUserPrincipal().getId(), photoId);
        if (photo != null) {
